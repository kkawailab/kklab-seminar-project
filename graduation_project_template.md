...
現在から想定する未来までに、社会、技術、制度、環境、人々の価値観がどのように変化したのかを説明してください。
...
従来のプログラムではなく、AIを利用する必要性を説明してください。
...
作品の有用性や使いやすさを、どのような方法で評価したかを説明してください。
...
※公開しても問題のないデモ専用アカウントのみを記載してください。
